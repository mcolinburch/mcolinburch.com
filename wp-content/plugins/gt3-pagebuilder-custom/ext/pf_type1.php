...
if (isset($pf)) {
	...
	if (function_exists ( "gt3_get_theme_option" ) && gt3_get_theme_option("demo_server") == "true" && ($gt3_current_page_sidebar == "left-sidebar" || $gt3_current_page_sidebar == "right-sidebar") && $gt3_this_is_bloglisting == true) {
			$video_height = 436;
		}
	if (function_exists ( "gt3_get_theme_option" ) && gt3_get_theme_option("demo_server") == "true" && $gt3_this_is_bloglisting == true && ($gt3_current_page_sidebar !== "left-sidebar" && $gt3_current_page_sidebar !== "right-sidebar")) {
		$video_height = 552;
	}
	/* end only for demo */
