					...
					<div class="portfolio_item_block">
						<div class="portfolio_item_wrapper">
							<div class="img_block wrapped_img">
								<a class="featured_ico_link" href="' . $linkToTheWork . '"><img src="' . aq_resize($featured_image[0], "570", "390", true, true, true) . '" alt=""><div class="featured_item_fadder"></div>
                                <div class="gallery_likes gallery_likes_add"><i data-icon-code="icon-search-plus" class="stand_icon icon-search-plus"></i></div></a>
							</div>
                            <p class="mcb_portfolio_title">' . get_the_title() . '</p>
						</div>						
					</div>
				</div>				
				';
