							...
							<div class="gallery_item_padding">
								<div class="gallery_item_wrapper">';
									if ($image['slide_type'] == "image") {
										$compile .= '<a class="featured_ico_link swipebox" rel="gallery-module" href="'. wp_get_attachment_url($image['attach_id']) .'" title="'.$photoTitleOutput.'">';
                                        $compile .= '<div class="gallery_likes gallery_likes_add"><i data-icon-code="icon-search-plus" class="stand_icon icon-search-plus"></i></div></a>';
									} else {
										$set_rel = '';
										...
										$compile .= '<a href="'. $image['src'] .'" class="featured_ico_link swipebox" rel="'. $set_rel .'" title="'.$photoTitleOutput.'">';
                                        $compile .= '<div class="gallery_likes gallery_likes_add"><i data-icon-code="icon-play-circle" class="stand_icon icon-play-circle"></i></div></a>';
                                        $videoTitle = '<p class="mcb_portfolio_title">' . $photoTitleOutput . '</p>';
									}									
									...
									<div class="gallery_fadder"></div>'.$videoTitle.'								
								</div>
							</div>
                        </div>
                        ';
