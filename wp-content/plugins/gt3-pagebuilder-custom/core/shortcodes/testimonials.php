                                ...
                                <div class='item'>
									<div class='testimonial_item_wrapper'>
										<div class='testimonials_photo'>
												".(strlen($featured_image[0])>0 ? "<img alt='' src='".aq_resize($featured_image[0], "130", "130", true, true, true)."' class='testimonials_ava'>" : "")."
										</div>
										<div class='testimonials_text'>
											<div class='testimonials_title'>
												<h5>{$testimonials_author},</h5><span class='company'>{$testimonials_company}</span>
											</div>
