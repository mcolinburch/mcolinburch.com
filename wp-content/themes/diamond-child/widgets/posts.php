		...
		$compilepopular .= '
			<li '.((has_post_thumbnail()) ? '' : 'class="no_img"').'>';
                if (has_post_thumbnail()) {
                    $compilepopular .= '<div class="recent_posts_img"><img src="'.aq_resize($featured_image_latest[0], "130", "130", true, true, true).'" alt="'.get_the_title().'"></div>';
                }
...
$compilepopular .= '
                <div class="recent_posts_content">
					...
					<span class="recent_posts_date"><i class="stand_icon icon-calendar-o"></i>'. get_the_time("F d, Y") .'</span>
                </div>
                <div class="clear"></div>
			</li>
		';
