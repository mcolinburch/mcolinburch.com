...
?>
    ...
    <script>
		...
		function centerWindow() {
			/*freeSpace = (window_h - countWrapper.height())/2;
			setTop = (freeSpace - countTitle.height())/2;
			setBottom = (freeSpace - countContainer.height())/2;
			console.log(freeSpace + ';' + setTop +';'+ setBottom);
			countTitle.css('top', setTop+'px');
			countContainer.css('bottom', setBottom+'px');*/

			freeSpace = (window_h - countWrapper.height() - countTitle.height() - countContainer.height())/4;
			setMiddle = freeSpace*2 + countTitle.height();
			//console.log(freeSpace + ';' + setTop +';'+ setBottom);
