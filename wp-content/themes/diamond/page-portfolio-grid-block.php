			...
			<?php } ?>
					<div class="fw-portPreview-wrapper mas_style1 zoom_hover_style" style="margin:0 40px 40px 0">
                            <a href="<?php echo $linkToTheWork; ?>" <?php echo $target; ?> class="main_link"></a>
                                <img src="<?php echo aq_resize($featured_image[0], "570", "570", true, true, true); ?>" alt="" class="fw_featured_image" width="570">
                                <div class="fw-portPreview-fadder"></div>
                                <div class="fw-portPreview-content">
                                    <h2 class="fw-portPreview-title"><a href="<?php echo $linkToTheWork; ?>" <?php echo $target; ?>><?php the_title(); ?></a></h2>
...
<?php 
		...
		<script>
			jQuery(document).ready(function($) {
				jQuery('.gallery_likes_add').on('click', function(e){
					e.preventDefault();
