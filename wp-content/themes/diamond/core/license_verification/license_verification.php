...
function gt3_activation_submenu_page_callback() {
    ...
    echo '<div class="gt3_register__buttons">';
        ...
        echo '<a href="javascript:void(0);" class="gt3_activation_refresh" title="'.__( 'Refresh Activation', 'wizecore' ).'"><i class="dashicons-before dashicons-update" aria-hidden="true"></i></a>';
    echo "</div>";
    ...
    if ($gt3_registration_status == 'active') {
        ...
        if (get_option( 'gt3_account_attached' ) == 'true') {
            echo "<div class='gt3_support_container gt3_info_container'>";
                echo '<div><strong>'.esc_html( 'The purchase code is linked to your GT3themes account', 'diamond' ).' </strong></div>';
                echo "<a class='button button-primary' href='http://accounts.gt3themes.com' style='color: #71c341;background: #ffffff;border-color: #ffffff;box-shadow: none;text-shadow: none;color: #d54e21;font-weight: 600;margin-top: 5px;'>". esc_html( "Go to Your Account", "diamond" ) ." </a>";
            echo "</div>";
        }else{
        ...
        if (function_exists('gt3_get_support_time_left')) {
            ...
            if (!empty($support_time_left['time_to_left'])) {
                ...
                echo '<div><a class="button button-primary" href="'. $theme_link .'" style="color: #71c341;background: #ffffff;border-color: #ffffff;box-shadow: none;text-shadow: none;color: #d54e21;font-weight: 600;margin-top: 5px;">'. esc_html( "Update Support Package", "diamond" ) .' <i class="dashicons dashicons-arrow-right-alt2" style="width: 1em;height: 1em;font-size: inherit;line-height: inherit;" aria-hidden="true"></i></a></div>';
                echo "</div>";
            }
        }
    }
...
function gt3_get_product_name (){
    $product = 'DIAMOND - Photography WordPress Theme';
    return $product;
}
...
function gt3_account_activation($code = '',$email = ''){
    ...
    if (!empty($email)) {
        ...
        if ( $response_code != 200 || is_wp_error( $version_info ) ) {
            $errore_return = new WP_Error( 'registration-error-connection-error', esc_html__( 'Registration Connection error', 'diamond' ) );
            return json_encode($errore_return);
        }
    }else{
        $errore_return = new WP_Error( 'registration-error-invalid-email', esc_html__( 'Please provide a valid email address.', 'diamond' ) );
        return json_encode($errore_return);
    }
...
function gt3_registration_notice() {
  ...
  <div class="notice notice-error" style="background-color: #d54e21; color: #ffffff; border-radius: 4px; padding: 10px 25px 10px 75px;position: relative;border-left: none;">
    ...
    <p style="font-size: 1.4em;font-weight: 500;margin-bottom: 0;"><?php esc_html_e( 'Purchase Validation! Please activate your theme.', 'diamond' ); ?></p>
    <div style="margin-bottom: 10px;"><a class="button button-primary" href="admin.php?page=gt3_activation_submenu_page" style="color: #ffffff;background: #ffffff;border-color: #ffffff;box-shadow: none;text-shadow: none;color: #d54e21;font-weight: 600;margin-top: 5px;"><?php esc_html_e( 'Register Now', 'diamond' ); ?> <i class="dashicons dashicons-arrow-right-alt2" style="width: 1em;height: 1em;font-size: inherit;line-height: inherit;" aria-hidden="true"></i></a> <a target="_blank" class="button button-primary" href="http://themeforest.net/cart/add_items?item_ids=9274644&ref=gt3themes" style="color: #ffffff;background: #ffffff;border-color: #ffffff;box-shadow: none;text-shadow: none;color: #d54e21;font-weight: 600;margin-top: 5px;"><?php esc_html_e( 'Buy Theme', 'diamond' ); ?> <i class="dashicons dashicons-arrow-right-alt2" style="width: 1em;height: 1em;font-size: inherit;line-height: inherit;" aria-hidden="true"></i></a></div>
  </div>
  <?php
}
...
function gt3_registration_notice_supported_until() {
  ...
  ?>
    <div class="notice notice-error is-dismissible" style="background-color: #d54e21; color: #ffffff; border-radius: 4px; padding: 10px 25px 10px 75px;position: relative;border-left: none;">
        ...
        if (!empty($support_time_left['expired']) && $support_time_left['expired'] == true) {
            esc_html_e( 'Your support package for this theme expired', 'diamond' ); ?><?php echo " ( ".$support_time_left['time_to_left']." ".esc_html( 'ago', 'diamond' )." ).";
        }else{
            esc_html_e( 'Your support package for this theme is about to expire', 'diamond' ); ?><?php echo " ( ".$support_time_left['time_to_left']." ".esc_html( 'left', 'diamond' )." )."; 
        }     
        ?></p>
        <div style="margin-bottom: 10px;"><a class="button button-primary" href="<?php echo $theme_link; ?>" style="color: #ffffff;background: #ffffff;border-color: #ffffff;box-shadow: none;text-shadow: none;color: #d54e21;font-weight: 600;margin-top: 5px;"><?php esc_html_e( 'Update Support Package', 'diamond' ); ?> <i class="dashicons dashicons-arrow-right-alt2" style="width: 1em;height: 1em;font-size: inherit;line-height: inherit;" aria-hidden="true"></i></a> <a class="button button-primary" href="<?php echo esc_url( wp_nonce_url( add_query_arg( 'gt3-hide-notice', 'notice_srart' ), 'gt3_hide_notices_nonce', '_gt3_notice_nonce' ) ); ?>" style="color: #ffffff;background: #ffffff;border-color: #ffffff;box-shadow: none;text-shadow: none;color: #d54e21;font-weight: 600;margin-top: 5px;"><?php esc_html_e( 'Dismiss this notice', 'diamond' ); ?> <i class="dashicons dashicons-arrow-right-alt2" style="width: 1em;height: 1em;font-size: inherit;line-height: inherit;" aria-hidden="true"></i></a></div>
    </div>
  <?php
    }
}
...
function gt3_hide_notice (){
    if ( isset( $_GET['gt3-hide-notice'] ) && isset( $_GET['_gt3_notice_nonce'] ) ) {
        if ( ! wp_verify_nonce( $_GET['_gt3_notice_nonce'], 'gt3_hide_notices_nonce' ) ) {
            wp_die( __( 'Action failed. Please refresh the page and retry.', 'diamond' ) );
        }
...
function gt3_account_notice(){    
  ...
  <div class="notice notice-warning" style="padding: 10px">
    <p><strong><?php esc_html_e( 'Create account and manage your theme purchase codes.', 'diamond' ) ?></strong></p>
    <p><strong><a href="admin.php?page=gt3_activation_submenu_page"><?php esc_html_e( 'Register Now', 'diamond' ); ?></a> |  <a href="<?php echo esc_url( wp_nonce_url( add_query_arg( 'gt3-hide-notice', 'account_notice_srart' ), 'gt3_hide_notices_nonce', '_gt3_notice_nonce' ) ); ?>"><?php esc_html_e( 'Dismiss this notice', 'diamond' ); ?></a></strong></p>
  </div>
  <?php
}
